...
I programmed the robot to follow set paths using timed motor movements like moving forward, turning, and stopping.

Line Following

I used infrared sensors to detect a line on the ground.
The robot can:
...
I used an ultrasonic sensor to detect objects in front of the robot.
